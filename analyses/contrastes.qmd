...
En premier lieu, on notera que l'intercept, comme avec les contrastes de type somme, correspond ici à la grande moyenne.[^contrastes-1]
...
Le coefficient `gradeII-I` correspond à la différence entre la moyenne du grade de niveau II et celle du niveau I.
...
mod2_sdif <- glm(
  ...
  family = binomial,
  data = hdv2003,
  contrasts = list(sexe = contr.sdif, groupe_ages = contr.sdif)
)
mod2_sdif |>
  tbl_regression(
    exponentiate = TRUE,
