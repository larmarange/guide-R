...
Dans le chapitre sur les estimations marginales, cf. @sec-estimations-marginales, nous avons présenté la fonction `broom.helpers::plot_marginalpredictions()` qui permet de représenter les prédictions marginales moyennes du modèle.
