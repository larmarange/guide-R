...
Pour automatiser l'ensemble de ce processus, on peut copier/coller le code de la fonction générique suivante[^regression-logistique-binaire-9] :
...
Le résultat obtenu est structement identique.
...
[^regression-logistique-binaire-9]: **Attention :** il s'agit d'une fonction expérimentale et elle n'est peut-être pas compatible avec tous types de modèles.
