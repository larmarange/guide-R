...
La fonction `guideR::tbl_maihda()` permet d'afficher les résultats[^maihda-6].

[^maihda-6]: Les intervalles de confiance et les p-valeurs des effets fixes nécessite une version récente de `{MAIHDA}` (≥0.2.1.9000).
