...
Alternativement, on peut réaliser une **régression logistique ordinale** aussi appelée **modèle cumulatif** ou **modèle logistique à égalité des pentes**. Ce type de modèle est plus simple que la régression multinomiale car il ne renvoie, dans sa version la plus fréquence, qu'un seul jeu de coefficients.
