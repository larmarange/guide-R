...
```{r}
#| label: tbl-predictions-marginales-moyennes-regression-ponderee
#| tbl-cap: Prédictions marginales moyennes du modèle pondéré
mod_quasi2 |> 
  tbl_regression(
