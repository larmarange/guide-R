...
*guide-R* est accompagné par un package homonyme, `{guideR}`, disponible sur **CRAN**, et qui fournit plusieurs fonctions utiles pour accompagner les analyses présentées ici.
...
Joseph Larmarange (`r lubridate::today() |> lubridate::year()`) *guide-R : Guide pour l’analyse de données d’enquêtes avec R*, <https://larmarange.github.io/guide-R/>, version du `r lubridate::today() |> format(format = "%d %B %Y")`, doi : [10.5281/zenodo.13923681](https://doi.org/10.5281/zenodo.13923681).
