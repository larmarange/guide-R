...
La fonction `guideR::view_dictionary()`, déjà présentée dans le chapitre sur les étiquettes de variables, cf. @#sec-etiquettes-variables, est ici aussi bien pratique.

```{r}
df |> guideR::view_dictionary()
```
:::
