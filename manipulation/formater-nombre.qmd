...
Pour créer une fonction de formatage personnalisée, on pourra avoir recours à `purrr::partial()` qui permet d'appeller <q>partiellement</q> une fonctio et qui renvoie une nouvelle fonction avec des paramètres par défaut personnalisés.
