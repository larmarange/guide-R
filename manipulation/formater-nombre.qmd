...
La fonction `guideR::leading_zeros()` de `{guideR}` permet d'afficher d'ajouter des 0 en début de nombre poru que chaque valeur soit affichée avec le même nombre de chiffres.
