...
Une variante est la fonction `num_cycle()` ci-après. On doit lui passer une condition / vecteur logique en entrée. Il numérote uniquement les <q>sous-groupes</q> remplissant la condition et renvoie `NA` sinon.
